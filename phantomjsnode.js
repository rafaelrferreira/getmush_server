...
phantom.create()
    ...
    .then(status => {
        console.log('#status');
        sitepage.render(title + '.png',  {format: 'png', quality: '100'});
       
        //sitepage.renderBase64('PNG', function(base64) {
            //console.log('base64: '+base64);
        //});
        //sitepage.renderBase64('PNG', (base64) => {
